...
API_ID = int(getenv("API_ID", "26135283"))
API_HASH = getenv("API_HASH", "60546a4ae74a53fb546cfab240545313")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", "7612276078"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "sapno_ka_saher")
UPDATE_CHNL = getenv("UPDATE_CHNL", "VILLAIN_MUSIC_UPDATE")
OWNER_USERNAME = getenv("OWNER_USERNAME", "NoT_YoUr_ViLLain")
