...
async def start(_, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await accha.edit("__𝗛𝗘𝗟𝗟𝗢 𝗕𝗔𝗕𝗬..__")
        await asyncio.sleep(0.2)
        await accha.edit("__𝗜'𝗠 𝗡𝗘𝗛𝗔..__")
        await asyncio.sleep(0.2)
        await accha.edit("__𝗦𝗧𝗔𝗥𝗧𝗜𝗡𝗚..__")
        await asyncio.sleep(0.2)
        await accha.edit("__𝗦𝗧𝗔𝗥𝗧𝗘𝗗..__")
        await asyncio.sleep(0.2)
        await accha.delete()
        ...
        await m.reply_photo(
            ...
            caption=f"""**╭───────────────────⦿**\n**│❍ ʜᴇʏ ɪ ᴀᴍ {BOT_NAME} •**\n**├───────────────────⦿**\n**│❍ ɪ ʀᴇᴀᴅ ʏᴏᴜʀ ᴍɪɴᴅ •**\n**│❍ ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ •**\n**├───────────────────⦿**\n**│❍ ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘs •**\n**│❍ ɪ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ •**\n**│❍ ғᴏʀ ᴀᴄᴛɪᴠᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ •**\n**│❍ ᴜsᴀɢᴇ /chatbot [ᴏɴ/ᴏғғ] •**\n**│❍ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ғᴏʀ ʜᴇʟᴘ •**\n**│❍ 24x7 ᴛɪᴍᴇ ᴏɴʟɪɴᴇ •**\n**├───────────────────⦿**\n**│❍ ᴍᴀᴅᴇ ʙʏ...[˹꯭ꪜ ꯭𝛊꯭ ꯭ʟ꯭꯭ ʟ ꯭᧘"‌꯭֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟፝𝛊 ꯭ꪀ ꯭‹𝟑꯭ !!꯭](https://t.me/VILLAIN_MUSIC_UPDATE)♡**\n**╰───────────────────⦿""",
